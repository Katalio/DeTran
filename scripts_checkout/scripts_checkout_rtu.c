...
static int _vstrsep(char *buf, const char *sep, ...)	//变参为char **型
{
	va_list ap;
	char **p, *k;
	int n = 0;
...
int scripts_checkout(const char *scripts, script_syntax_error_info *err_infolist)
{
